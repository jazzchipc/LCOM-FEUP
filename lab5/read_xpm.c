...
#define HRES_0x105_MODE 1024
#define VRES_0x105_MODE 728
...
char *read_xpm(char *map[], int *wd, int *ht)
{
  ...
  printf("%d %d %d\n", width, height, colors);
#endif
  if (width > HRES_0x105_MODE || height > VRES_0x105_MODE || colors > 256) {	//this line has been altered to work with 0x105 graphics mode
    printf("read_xpm: incorrect width, height, colors\n");
    return NULL;
  }
